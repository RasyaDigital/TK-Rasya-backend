...
public class PerkembanganAspekController {
        ...
        public ResponseEntity<?> getPerkembanganByAnakAndDateRange(
                ...
                try {
                        ...
                        List<PerkembanganAspek> list = perkembanganAspekService.getPerkembanganAspekByAnakAndDateRange(
                                        idAnak,
                                        startDate, endDate);
                        return ResponseEntity.ok(
                                        ApiResponse.builder()
         ...
         */
        @PostMapping
        public ResponseEntity<?> inputPerkembanganAspek(@RequestBody com.monitoringanak.dto.PerkembanganAspekDTO dto,
                        HttpServletRequest request) {
                try {
                        String userRole = (String) request.getAttribute("userRole");
                        ...
                        entity.setAgamaMoral(dto.getAgamaMoral());
                        entity.setFisikMotorik(dto.getFisikMotorik());
                        entity.setKognitif(dto.getKognitif());
                        entity.setBahasa(dto.getBahasa());
                        entity.setSosialEmosional(dto.getSosialEmosional());
                        entity.setSeni(dto.getSeni());
                        entity.setCatatan(dto.getCatatan());

                        PerkembanganAspek created = perkembanganAspekService.inputPerkembanganAspek(entity);
         ...
         */
        @PutMapping("/{idAspek}")
        public ResponseEntity<?> updatePerkembangan(@PathVariable Integer idAspek,
                        @RequestBody PerkembanganAspek details,
                        HttpServletRequest request) {
                try {
                        String userRole = (String) request.getAttribute("userRole");
